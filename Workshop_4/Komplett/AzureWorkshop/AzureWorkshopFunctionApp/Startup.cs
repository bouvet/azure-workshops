...
namespace AzureWorkshopFunctionApp
{
    ...
    public class Startup : FunctionsStartup
    {
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services.AddScoped<IBlobStorageService, BlobStorageService>((s) => { return new BlobStorageService(Environment.GetEnvironmentVariable(Constants.ConnectionString)); });
