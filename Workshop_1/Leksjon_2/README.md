...
3. Gå til til valget "Scale up", endre denne til en plan i "Standard tier" under "Production". Man kan kun skalere opp med flere instanser ved å bruke Standard eller Premium tier. Disse koster mer enn Free/Shared/Basic tier.
