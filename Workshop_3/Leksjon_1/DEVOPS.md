# Oppsett av applikasjon i Azure DevOps.
...
2. Lag en ny organisasjon om du ikke har en allerede.
3. Lag et nytt privat prosjekt med Git som version controll og Agile som work item process.
